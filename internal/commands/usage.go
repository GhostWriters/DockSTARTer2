...
func GetUsage(target string, noHeading bool) string {
	...
	if match("-c", "--compose") {
		printStr(
			"{{|UsageCommand|}}-c --compose{{[-]}} < {{|UsageOption|}}pull{{[-]}} | {{|UsageOption|}}up{{[-]}} | {{|UsageOption|}}down{{[-]}} | {{|UsageOption|}}stop{{[-]}} | {{|UsageOption|}}start{{[-]}} | {{|UsageOption|}}restart{{[-]}} | {{|UsageOption|}}create{{[-]}} | {{|UsageOption|}}kill{{[-]}} | {{|UsageOption|}}pause{{[-]}} | {{|UsageOption|}}unpause{{[-]}} | {{|UsageOption|}}update{{[-]}} > [{{|UsageApp|}}<app>{{[-]}} ...]{{[-]}}",
