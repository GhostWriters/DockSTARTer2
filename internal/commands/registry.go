...
var Registry = map[string]Def{
	...
	"--theme-large-buttons":      {Title: "Turned On Large Buttons", SessionLocked: true, ConsoleSafe: true, ConfigChanging: true},
	"--theme-no-large-buttons":   {Title: "Turned Off Large Buttons", SessionLocked: true, ConsoleSafe: true, ConfigChanging: true},
