...
var Registry = map[string]Def{
	...
	"--theme-advanced":            {Title: "Showing advanced appearance settings by default.", SessionLocked: false, ConsoleSafe: true, ConfigChanging: true},
	"--theme-no-advanced":         {Title: "Hiding advanced appearance settings by default.", SessionLocked: false, ConsoleSafe: true, ConfigChanging: true},
	"--theme-pane-layout":         {Title: "Set Theme/Tint Layout", SessionLocked: false, ConsoleSafe: true, ConfigChanging: true},
	...
	"--tint-list":                 {Title: "List Tint Schemes", ConsoleSafe: true},
	"--tint-table":                {Title: "Tint Schemes Table", ConsoleSafe: true},
