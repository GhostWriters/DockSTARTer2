...
var Registry = map[string]Def{
	...
	"--theme-shadows":            {Title: "Turned On Shadows", SessionLocked: false, ConsoleSafe: true, ConfigChanging: true},
	"--theme-no-shadows":         {Title: "Turned Off Shadows", SessionLocked: false, ConsoleSafe: true, ConfigChanging: true},
	"--theme-shadow":             {Title: "Turned On Shadows", SessionLocked: false, ConsoleSafe: true, ConfigChanging: true},
	"--theme-no-shadow":          {Title: "Turned Off Shadows", SessionLocked: false, ConsoleSafe: true, ConfigChanging: true},
	...
	"--theme-no-line":            {Title: "Turned Off Line Drawing", SessionLocked: false, ConsoleSafe: true, ConfigChanging: true},
	"--theme-borders":            {Title: "Turned On Borders", SessionLocked: false, ConsoleSafe: true, ConfigChanging: true},
	"--theme-no-borders":         {Title: "Turned Off Borders", SessionLocked: false, ConsoleSafe: true, ConfigChanging: true},
	"--theme-border":             {Title: "Turned On Borders", SessionLocked: false, ConsoleSafe: true, ConfigChanging: true},
	"--theme-no-border":          {Title: "Turned Off Borders", SessionLocked: false, ConsoleSafe: true, ConfigChanging: true},
	"--theme-large-buttons":      {Title: "Turned On Large Buttons", SessionLocked: false, ConsoleSafe: true, ConfigChanging: true},
	"--theme-no-large-buttons":   {Title: "Turned Off Large Buttons", SessionLocked: false, ConsoleSafe: true, ConfigChanging: true},
