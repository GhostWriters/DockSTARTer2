...
func NewFlagSet() *pflag.FlagSet {
	...
	fs.String("tint-repo", "", "Set an ANSI palette tint from a tinted-theming base16 scheme name (local/ssh/web/all)")
	fs.String("tint-file", "", "Set an ANSI palette tint from a local base16 scheme file (local/ssh/web/all)")
