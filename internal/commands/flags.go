...
func NewFlagSet() *pflag.FlagSet {
	...
	fs.Bool("tint", false, "Show current ANSI palette tint status for local/ssh/web")
	fs.String("tint-repo", "", "Set an ANSI palette tint from a tinted-theming base16 scheme name (local/ssh/web/all, default all)")
	fs.String("tint-embedded", "", "Set an ANSI palette tint from one of DS2's own bundled base16 schemes (local/ssh/web/all, default all)")
	...
	fs.Bool("theme-no-cli-tint", false, "Disable ANSI palette tint for non-interactive CLI output (the interactive TUI is unaffected)")
	fs.Bool("theme-programbox-tint", false, "Enable ANSI palette tint for ProgramBox dialog output")
	fs.Bool("theme-no-programbox-tint", false, "Disable ANSI palette tint for ProgramBox dialog output (renders with the terminal's own palette)")
	...
	fs.String("theme-ansi-override", "", "Enable already-configured ANSI color overrides (local/ssh/web/all, default all)")
	fs.String("theme-no-ansi-override", "", "Disable ANSI color overrides without discarding them (local/ssh/web/all, default all)")
